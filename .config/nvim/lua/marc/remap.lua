...
-- copy to system's clipboard (which corresponds to "+
...
-- go to previous buffer (useful when jumping to definitions with LSP)
vim.keymap.set("n", "<leader>pb", function() vim.cmd("b#") end)
